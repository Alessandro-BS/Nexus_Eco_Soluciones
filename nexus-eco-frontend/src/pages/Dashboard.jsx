    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="kpi-grid">
                <div className="kpi-card premium-card card-indigo">
                ...
                <div className="kpi-card premium-card card-emerald">
                ...
                <div className="kpi-card premium-card card-amber">
                ...
                <div className="kpi-card premium-card card-red">
                    ...
                    <div className="kpi-content">
                        ...
                        <div className="kpi-value">{totalIncidentes}</div>
                    </div>
                </div>
            </div>
